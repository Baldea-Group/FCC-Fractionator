function [Temperatureout,Vaporout,xcout,Liqout,Holdout,EnthalLout,EnthalVout,LN,HN,LCO,ELC2,ETC4,ETC5,ETC6,Ttrack1,Ttrack2,yout,Valvesf]=Fractionator(xfra,ufra,xc,MV,SP,products,errord,Xfil,dist,cont)
%**************************************************************************************************************************************************************************************************************************************************************************************************************************
